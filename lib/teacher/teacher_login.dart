...
import 'package:shiksha/student/teacher_profile.dart';
import 'package:shiksha/teacher/teacher_signup.dart';
...
class _TeacherLoginScreenState extends State<TeacherLoginScreen> {
  ...
  Future<void> sendLoginRequest(BuildContext context) async {
    try {
      ...
      request.fields['login_type'] = 'teacher';
      ...
      if (response.statusCode == 200) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const TeacherProfileScreen(selectedIndex: 0),
          ),
        );
